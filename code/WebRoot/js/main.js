Ext.BLANK_IMAGE_URL = '/rbac/resources/images/default/s.gif';
Ext.QuickTips.init();
var start = {
	id : 'start-panel',
	title : '欢迎使用',
	...
	html : '<img src="/rbac/images/bg.jpg"/>'
};
	...
	setTimeout(function() {
		...
		var vp = new Ext.Viewport({
			...
			items : [{
					...
					items : [{
						...
						items : [{
							...
							loader : new Ext.tree.TreeLoader({
								dataUrl : '/rbac/js/tree-data-manager.json'										
							}),
				...
				activeItem : 0,
				border : false,
				items : [start, p_myuser, p_perm, p_role]
			}]
		});
	}, 250);
});
